...
const SearchBlock = () => {
    ...
    return (
            <div className={styles.root}>
                <input value={searchValue} onChange={e => setSearchValue(e.target.value)} className={styles.input} placeholder='Введите название пиццы'/>
